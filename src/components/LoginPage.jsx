...
// import { Button, Spinner } from "@/components/ui"; // Assuming Button and Spinner are custom
// // import { EyeIcon, PhoneIcon, EnvelopeIcon } from "@heroicons/react/24/outline"; // Standard icons
...
//                 className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-indigo-500 outline-none transition-all placeholder:text-gray-950 text-gray-950"
//               />
//               {errors.email && (
...
//               <a
//                 href="#"
//                 className="text-sm text-[#374151] font-medium hover:underline"
//               >
//                 Forget Password?
//               </a>
//             </div>
...
//               type="submit"
//               disabled={loading}
//               className="w-full bg-[#6336FF] hover:bg-[#5229e6] text-white font-semibold py-3.5 rounded-xl transition-all shadow-md active:scale-[0.98]"
//             >
...
//           </div>
//           <div className="flex items-center gap-2">
//             {/* <EnvelopeIcon className="h-4 w-4" /> */}🤷‍♂️
